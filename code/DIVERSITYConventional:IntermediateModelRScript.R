...
#Need to set working directory to code before running this
...
#Running optimum model as defined by AIC values
prokaryote.model2 <- rma.mv(yi=prokaryotes_subset$LRR,
                            V=prokaryotes_subset$LRR_var,
                            random = list(~ 1 | ID, ~ 1 | Length.of.Experiment),
                            mods = ~ SoilType + Crop.Type + Climate,
                            slab=ID,
                            data=prokaryotes_subset)
summary(prokaryote.model2)
...
#Running optimum model as defined by AIC values
eukaryote.model2 <- rma.mv(yi=eukaryotes_subset$LRR,
                            V=eukaryotes_subset$LRR_var,
                            mods = ~ SoilType + Crop.Type,
                            slab=ID,
                            data=eukaryotes_subset)
summary(eukaryote.model2)
